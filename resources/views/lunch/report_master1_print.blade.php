...
foreach($abs_data as $k=>$v){
    if($last_class != substr($k,0,3) and !empty($last_class)){
        $data .="</table>頁：".$page."<br>承辦：<p style='page-break-after:always'></p><h1 align='center'>和東國小".substr($semester,0,3)."學年第".substr($semester,3,1)."學期學生午餐退費印領清冊</h1><table style='border: 1px solid #000000;border-collapse: collapse;'><tr style='border: 1px solid #000000;'><td style='border: 1px solid #000000;width:50px'>班級</td><td style='border: 1px solid #000000;width:50px'>座號</td><td style='border: 1px solid #000000;width:80px'>姓名</td><td style='border: 1px solid #000000;width:70px'>請假天數</td><td style='border: 1px solid #000000;width:50px'>退費</td><td style='border: 1px solid #000000;width:120px'>簽名</td><td style='border: 1px solid #000000;'>請假日期</td></tr>";
...
$data .= "</table>頁：".$page."<br>承辦人　　　　　　　　　主辨出納　　　　　　　　　主辨會計　　　　　　　　　機關長官";
$title= "<h1 align='center'>和東國小".substr($semester,0,3)."學年第".substr($semester,3,1)."學期學生午餐退費印領清冊</h1><h2>一、全校總退餐次： ".$total_times." 次</h2><h2>二、全校總退餐費： ".$total_money." 元</h2><h2>三、以下各班詳細資料共 ".$page." 頁</h2>";
$data = $title.$data;
